...
- **`ST-D31`** (แทนที่ `ST-D22`) — การแบ่งสัดส่วนการเลี้ยว**รายเลน**ในตารางชั้นความลับ
  **ยังไม่มีอะไรตรวจสอบมันได้** ถ้าสลับป้าย edge ถัดไประหว่างสอง movement ที่เลนหนึ่งรองรับ
  เนื้อในตารางจะเปลี่ยนไป 74% **และจะไม่มีเทสต์ตัวไหนล้มเลยสักตัว** เพราะตารางไม่มีคีย์ระบุตัวรถ
  จึงกระทบยอดกับ traversal stream ไม่ได้ กำหนดเวลาถูกแยกเป็นสอง: **การแก้ฝั่งคนเขียน**ลงที่ M1b
  เพราะ run ทุกอันที่เขียนก่อนหน้านั้นจะกระทบยอดไม่ได้ตลอดกาล ส่วน**ตัวประมาณ**ที่มาใช้มัน
  ย้ายไป M8 พร้อมงานสัดส่วนการเลี้ยวที่เหลือ
